...
window.onload = function init()
{
	...
	//Initialize textures
	initializeTexture(image, "basket.jpg", 0);
	initializeTexture(image, "basket.jpg", 1);
	initializeTexture(image, "basket.jpg", 2);
	initializeTexture(image, "basket.jpg", 3);
...
function render()
{
    ...
    translations[2] = -7;
    mvMatrix = mat4( );
    mvMatrix = mult(mvMatrix, translate((translations[0] + targetMoveOne), translations[1], translations[2]));
